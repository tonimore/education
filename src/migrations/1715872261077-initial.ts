...
export class Initial1715872261077 implements MigrationInterface {
    name = 'Initial1715872261077'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "supplier" ("id" SERIAL NOT NULL, "fullname" character varying NOT NULL, "address" integer NOT NULL, "phone" integer NOT NULL, "email" integer NOT NULL, CONSTRAINT "PK_2bc0d2cab6276144d2ff98a2828" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "goods" ("id" SERIAL NOT NULL, "fullname" character varying NOT NULL, "category_id" integer NOT NULL, "rating" integer NOT NULL, CONSTRAINT "PK_105e56546afe0823fa08df0baf7" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "supplier_good" ("supplier_id" integer NOT NULL, "good_id" integer NOT NULL, CONSTRAINT "PK_99549ddd54b9b8606a36218e24a" PRIMARY KEY ("supplier_id", "good_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "supplier_good" ADD CONSTRAINT "FK_844f980b617b0a844fa0738d346" FOREIGN KEY ("supplier_id") REFERENCES "supplier"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
